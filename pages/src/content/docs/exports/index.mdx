...
`Export()` 函数 ([`driverbox/export.go`](https://github.com/ibuilding-x/driver-box/blob/master/driverbox/export.go)) 负责数据分发：
...
`pointCacheFilter()` ([`driverbox/export.go`](https://github.com/ibuilding-x/driver-box/blob/master/driverbox/export.go)) 执行以下操作：
...
`pointValueProcess()` ([`driverbox/export.go`](https://github.com/ibuilding-x/driver-box/blob/master/driverbox/export.go)) 对点位值进行加工：
...
所有导出插件必须实现 `Export` 接口 ([`driverbox/export/export.go`](https://github.com/ibuilding-x/driver-box/blob/master/driverbox/export/export.go))：
...
**DeviceData** ([`driverbox/plugin/model.go`](https://github.com/ibuilding-x/driver-box/blob/master/driverbox/plugin/model.go))：
...
**ExportType** ([`driverbox/plugin/model.go`](https://github.com/ibuilding-x/driver-box/blob/master/driverbox/plugin/model.go))：
...
导出系统支持多种事件类型 ([`pkg/event/event.go`](https://github.com/ibuilding-x/driver-box/blob/master/pkg/event/event.go))：
...
`EnableExport()` ([`driverbox/export.go`](https://github.com/ibuilding-x/driver-box/blob/master/driverbox/export.go)) 注册导出插件：
...
MQTT 导出将设备数据发布到 MQTT Broker ([`exports/mqtt/mqtt_export.go`](https://github.com/ibuilding-x/driver-box/blob/master/exports/mqtt/mqtt_export.go))：
...
History 导出将设备数据存储到 SQLite 数据库 ([`exports/history/export.go`](https://github.com/ibuilding-x/driver-box/blob/master/exports/history/export.go))：
...
IEC104 当前提供[主站通信插件](/driver-box/plugins/iec104/)，尚未注册从站 export。后续从站应独立实现监听、总召应答和遥控转发，并复用 `pkg/iec104` 的地址、点位与样本定义；实现边界参见 [IEC104 扩展说明](/driver-box/plugins/iec104/#后续-iec104-从站-export-的扩展方式)。
