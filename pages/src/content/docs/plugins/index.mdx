...
- [**核心缓存**](/driver-box/concepts/corecache/) - 了解配置管理和数据缓存
- [**设备影子**](/driver-box/concepts/device-shadow/) - 了解设备数据存储和管理
- [**导出系统**](/driver-box/concepts/export-system/) - 了解数据导出机制
- [**配置化接入**](/driver-box/concepts/configuration-driven/) - 了解配置文件结构
- [**架构设计**](/driver-box/concepts/architecture/) - 了解整体架构设计
- [**插件二次开发指南**](/driver-box/plugins/development/) - 学习如何开发自定义协议插件