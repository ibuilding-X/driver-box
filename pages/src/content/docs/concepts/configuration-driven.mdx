...
<Tabs>
    ...
    <TabItem label="connections">
        ...
        - [Modbus 连接配置](/plugins/modbus/#modbus连接配置)
        - MQTT 连接配置
        - HTTP Server 连接配置
        - TCP Server 连接配置
    </TabItem>
...
- [CoreCache](/concepts/corecache/) - 了解核心缓存系统如何加载配置
- [Library](/concepts/library/) - 了解资源库中的模型和驱动配置
- [Plugin 机制](/concepts/plugin-system/) - 了解插件如何使用配置
- [快速开始](/guides/getting-started/) - 查看完整配置示例
