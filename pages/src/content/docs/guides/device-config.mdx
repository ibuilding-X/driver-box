...
配置对应的 Go 结构体定义位于 [`pkg/config/device_config.go`](https://github.com/your-repo/blob/master/pkg/config/device_config.go)
...
配置对应的 Go 结构体定义位于 [`pkg/config/device_config_model.go`](https://github.com/your-repo/blob/master/pkg/config/device_config_model.go)
...
配置对应的 Go 结构体定义位于 [`pkg/config/device_config_device.go`](https://github.com/your-repo/blob/master/pkg/config/device_config_device.go)
...
配置对应的 Go 结构体和方法定义位于 [`pkg/config/device_config_model_point.go`](https://github.com/your-repo/blob/master/pkg/config/device_config_model_point.go)
